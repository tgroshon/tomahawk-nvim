-- Vendored from Omarchy's stock Neovim config
-- (~/.config/nvim/lua/config/remote_clipboard.lua). Kept byte-identical below the
-- header so it can be diffed against upstream after an `omarchy update`.
--
